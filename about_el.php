...
<div class="events-bgr">
    ...
    <section class="home-nine about-four">
        <div class="container">
            ...
            <p><a href="#fancyboxID-1" class="button fancybox-inline">Υποβάλλω αίτηση</a></p>
            <div id="fancyboxID-1" class="fancybox-hidden hentry" style="width:460px;max-width:100%;">
                <p><?php echo do_shortcode( '[contact-form-7 id="2653" title="Tour Operators GR"]'); ?></p>
            </div>
        </div>
    </section> 
    ...
    <section class="home-five about-five">
        <div class="container">
            <div class="content">
              ...
              <a class="button" href="https://cosmoport.eu/el/shkolam/">Περισσότερο</a>
        </div>
    </section> 
    ...
    <section class="home-five home-seven about-six">
        <div class="container">
            <div class="content">
                ...
                <a class="button" href="https://cosmoport.eu/el/partnery/">Περισσότερο</a>
            </div>
        </div>
    </section> 
