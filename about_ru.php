...
<div class="events-bgr">
    ...
    <section class="home-nine about-four">
        <div class="container">
            ...
            <p><a href="#fancyboxID-1" class="button fancybox-inline">Отправить заявку</a></p>
            <div id="fancyboxID-1" class="fancybox-hidden hentry" style="width:460px;max-width:100%;">
                <p><?php echo do_shortcode( '[contact-form-7 id="2654" title="Tour Operators RU"]'); ?></p>
            </div>
        </div>
    </section> 
    ...
    <section class="home-five about-five">
        <div class="container">
            <div class="content">
             ...
             <a class="button" href="https://cosmoport.eu/ru/for_schools/">Подробнее</a>
            </div>
        </div>
    </section> 
    ...
    <section class="home-five home-seven about-six">
        <div class="container">
            <div class="content">
             ...
             <a class="button" href="https://cosmoport.eu/ru/partners_ru/">Подробнее</a>
            </div>
        </div>
    </section> 
    ...
    <section class="home-five events-two event-four about-seven">
        <div class="container">
            <div class="content">
                ...
                <a class="button" href="https://cosmoport.eu/ru/events_ru/">еще</a>
            </div>
        </div>
    </section> 
