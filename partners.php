...
<div class="events-bgr">
    ...
    <section class="home-five home-seven about-six">
        <div class="container">
            ...
            <p><a href="#fancyboxID-3" class="button fancybox-inline">become a partner</a></p>
            <div id="fancyboxID-3" class="fancybox-hidden hentry" style="width:460px;max-width:100%;">
                <p><?php echo do_shortcode( '[contact-form-7 id="2655" title="Partnership EN"]'); ?></p>
            </div>
            </div>
        </div>
    </section> 
