        ...
        <div class="container">
            <div class="content">
                ...
                <h3><?php echo get_field('price-three-podagolovok') ?></h3>
                    ...
                    <a class="button" href="https://cosmoport.eu/activities_ru/dni-rozhdeniya/">подробнее</a>
            </div>
        </div>
    </section> 
        ...
        <div class="container">
            <div class="content">
                ...
                <h3><?php echo get_field('price-four-podagolovok') ?></h3>
                    ...
                    <a class="button" href="https://cosmoport.eu/activities_ru/master-klassy/">подробнее</a>
            </div>
        </div>
    </section> 
        ...
        <div class="container">
            <div class="content">
                ...
                <h3><?php echo get_field('price-five-podagolovok') ?></h3>
                    ...
                    <a class="button" href="https://cosmoport.eu/activities_ru/korporativy/">подробнее</a>
            </div>
        </div>
    </section> 
        ...
        <div class="container">
            <div class="content">
                ...
                <h3><?php echo get_field('price-six-podagolovok') ?></h3>
                    ...
                    <a class="button" href="https://cosmoport.eu/activities_ru/interaktivnye-instalyaczii/">подробнее</a>
            </div>
        </div>
    </section> 
        ...
        <div class="container">
            <div class="content">
                ...
                <h3><?php echo get_field('price-seven-podagolovok') ?></h3>
                    ...
                    <a class="button" href="https://cosmoport.eu/activities_ru/vr-attrakcziony/">подробнее</a>
            </div>
        </div>
    </section> 
