...
<div class="events-bgr">
    ...
    <section class="home-five home-seven about-six">
        <div class="container">
            ...
            <p><a href="#fancyboxID-4" class="button fancybox-inline">стать партнером</a></p>
            <div id="fancyboxID-4" class="fancybox-hidden hentry" style="width:460px;max-width:100%;">
                <p><?php echo do_shortcode( '[contact-form-7 id="2656" title="Partnership RU"]'); ?></p>
            </div>
            </div>
        </div>
    </section> 
