<?php
    /*
    Template Name: Birthsdays-new
    Template Post Type: activities
    */
?>
...
<div class="content">
  <div class="container">
    <div class="breadsrumbs">
      <ul>
        <li><a href="<?php echo get_home_url(); ?>">Home</a> <span class="divider">-</span></li>
        <li><a href="<?php echo get_permalink(429); ?>">Activities</a> <span class="divider">-</span></li>
  ...
  <div class="price-calculator">
    ...
    <div class="price-calculator-img">
      ...
      <div id="fancyboxID-8" class="fancybox-hidden" style="width:460px;max-width:100%;">
        <p><?php echo do_shortcode( '[contact-form-7 id="3030" title="Birthday_bookings_EN"]'); ?></p>
      </div> 
    </div>
...
<div class="button-call">
  <button><a style="color:inherit;" href="<?php echo get_permalink(2506); ?>"><?php echo get_field('price-three-knopka-1')?></a></button>
</div>
