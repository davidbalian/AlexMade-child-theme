                    ...
                    <div class="price-two-block">
                        <?php foreach (get_field('price-three-blok') as $key => $value): ?> 
                            <div class="price-two-item">
                                ...
                                <a class="button" href="/activities_ru/dni-rozhdeniya-booking/">Забронировать</a>
                            </div>
                        <?php endforeach ?>
                    </div>
                    <a class="button" href="<?php echo get_field('price-three-ssylka') ?>">подробнее</a>
            </div>
        </div>
    </section> 
        ...
        <div class="container">
            <div class="content">
                ...
                <h3><?php echo get_field('price-four-podagolovok') ?></h3>
                    ...
                    <a class="button" href="<?php echo get_field('price-four-ssylka') ?>">подробнее</a>
            </div>
        </div>
    </section> 
        ...
        <div class="container">
            <div class="content">
                ...
                <h3><?php echo get_field('price-five-podagolovok') ?></h3>
                    ...
                    <a class="button" href="<?php echo get_field('price-five-ssylka') ?>">подробнее</a>
            </div>
        </div>
    </section> 
        ...
        <div class="container">
            <div class="content">
                ...
                <h3><?php echo get_field('price-six-podagolovok') ?></h3>
                    ...
                    <a class="button" href="<?php echo get_field('price-six-ssylka') ?>">подробнее</a>
            </div>
        </div>
    </section> 
        ...
        <div class="container">
            <div class="content">
                ...
                <h3><?php echo get_field('price-seven-podagolovok') ?></h3>
                    ...
                    <a class="button" href="<?php echo get_field('price-seven-ssylka') ?>">подробнее</a>
            </div>
        </div>
    </section> 
