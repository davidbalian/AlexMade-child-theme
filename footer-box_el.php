   ...
   <div class="footer-top">
      <div class="container">
        <div class="footer-col">
           ...
           <span class="footer-text"><?php echo get_field('footer-tekst_el', 'OPTIONS') ?></span> 
        </div>
        <div class="footer-col">
          <div class="footer-menu">
            <?php foreach (get_field('footer-menyu_1_el', 'OPTIONS') as $key => $value): ?>
          ...
          <div class="footer-cab">
            ...
            <span>Προσωπικός Χώρος</span>
          </div>
          -->
        </div>
        <div class="footer-col">
          <div class="footer-menu">
            <?php foreach (get_field('footer-menyu_2_el', 'OPTIONS') as $key => $value): ?>
              <a href="<?=$value['footer-ssylka']?>"><?=$value['footer-tekst']?></a>
            <?php endforeach ?>
          </div>
        </div>
        ...
        <div class="work <?php echo date('l'); ?> <?php echo current_time('H:i'); ?>">
          ...
          <div class="social">
            <?php foreach (get_field('footer-soczialnye_seti_el', 'OPTIONS') as $key => $value): ?>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="contant">
            <?php foreach (get_field('footer-menyu_3_el', 'OPTIONS') as $key => $value): ?>
              <a href="<?=$value['footer-ssylka']?>"><?=$value['footer-tekst']?></a>
            <?php endforeach ?>
        </div>
      </div>
