<?php
    /*
    Template Name: Birthsdays-new ru
  ...
  <div class="price-calculator">
    ...
    <div class="price-calculator-img">
      ...
      <div id="fancyboxID-8" class="fancybox-hidden" style="width:460px;max-width:100%;">
        <p><?php echo do_shortcode( '[contact-form-7 id="3023" title="Birthday_bookings_RU"]'); ?></p>
      </div> 
    </div>
...
function calculateTotalPrice() {
  ...
  if (isNaN(totalChildren)) {
    totalPriceElement.textContent = 'Ошибка расчета цены';
  } else {
...
<div class="button-call">
  <button><a style="color:inherit;" href="<?php echo get_permalink(2508); ?>"><?php echo get_field('price-three-knopka-1')?></a></button>
</div>
