    ...
    <div class="container">
        ...
        <div class="home-two-swiper" style="display:none;">
            <div thumbsSlider="" class="swiper mySwiper2">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="swiper-button">1st floor</div>
                        <img src="<?php echo get_home_url(); ?>/wp-content/themes/AlexMade/img/act.png">
                    </div>
                    <div class="swiper-slide">
                        <div class="swiper-button">2nd floor</div>
                        <img src="<?php echo get_home_url(); ?>/wp-content/themes/AlexMade/img/act.png">
                    </div>
...
<section class="home-four">
    <div class="container">
        ...
        <?php echo do_shortcode( '[contact-form-7 id="1730" title="booking"]' ); ?>
    </div>
</section>  
...
<section class="home-five events-two event-four">
    <div class="container">
        <div class="content">
            ...
            <a class="button" href="<?php echo get_home_url(); ?>/event/">more</a>
        </div>
    </div>
</section> 
    ...
    <div class="container">
        <div class="content">
            ...
            <div class="home-six-block">
              ...
              <a class="button" href="https://cosmoport.eu/video/">more</a>
        </div>
    </div>
</section> 
