    ...
    <section class="home-five home-seven about-six">
        <div class="container">
            <div class="content">
                ...
                <p><a href="#fancyboxID-10" class="button fancybox-inline">Επικοινωνήστε μαζί μας</a></p>
            <div id="fancyboxID-10" class="fancybox-hidden hentry" style="width:460px;max-width:100%;">
                <p><?php echo do_shortcode( '[[contact-form-7 id="2679" title="Loyalty_Inquiry_EL"]"]'); ?></p>
            </div>
            </div>
        </div>
    </section> 
