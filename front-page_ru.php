    ...
    <div class="container">
        ...
        <div class="home-two-swiper" style="display:none;">
            <div thumbsSlider="" class="swiper mySwiper2">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="swiper-button">1 этаж</div>
                        <img src="<?php echo get_home_url(); ?>/wp-content/themes/AlexMade/img/act.png">
                    </div>
                    <div class="swiper-slide">
                        <div class="swiper-button">2 этаж</div>
                        <img src="<?php echo get_home_url(); ?>/wp-content/themes/AlexMade/img/act.png">
                    </div>
...
<section class="home-four">
    <div class="container">
        ...
        <?php echo do_shortcode( '[contact-form-7 id="1738" title="Booking_ru"]' ); ?>
    </div>
</section>  
...
<section class="home-five events-two event-four">
    <div class="container">
        <div class="content">
            ...
            <a class="button" href="<?php echo get_home_url(); ?>/ru/sobytiya/">еще</a>
        </div>
    </div>
</section> 
...
<section class="home-five">
    <div class="container">
        <div class="content">
            ...
            <a class="button" href="https://cosmoport.eu/video-2/">еще</a>
        </div>
    </div>
</section> 
...
<section class="home-five home-seven">
    <div class="container">
        <div class="content">
            ...
            <a class="button" href="https://cosmoport.eu/ru/partnery/">ПОДРОБНЕЕ</a>
        </div>
    </div>
</section> 
