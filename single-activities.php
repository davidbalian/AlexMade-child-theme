...
<? //                         <div class="button">Book</div> ?>
    ...
    <section class="home-five school-five activ-five">
        <div class="container">
            ...
            <p><a href="#fancyboxID-20" class="button fancybox-inline">UNIQUE EVENT</a></p>
            <div id="fancyboxID-20" class="fancybox-hidden hentry" style="width:460px;max-width:100%;">
                <p><?php echo do_shortcode( '[contact-form-7 id="2747" title="Booking_Corp EN"]'); ?></p>
            </div>                
                ...
                <?php if ( 573 == $post->ID ) : ?>
            <p><a href="#fancyboxID-20" class="button fancybox-inline">BOOK</a></p>
            <div id="fancyboxID-20" class="fancybox-hidden hentry" style="width:460px;max-width:100%;">
                <p><?php echo do_shortcode( '[contact-form-7 id="2747" title="Booking_Corp EN"]'); ?></p>
            </div>                
